  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <p className="font-medium text-white group-hover:text-[var(--ratist-red)] transition-colors line-clamp-2" title={show.name}>{show.name}</p>
        <p className="text-xs text-[var(--foreground-muted)] mt-0.5">
          {show.first_air_date?.slice(0, 4) || "TBA"}
