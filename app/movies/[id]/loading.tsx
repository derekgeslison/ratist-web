// Route-level loading skeleton for /movies/[id]. Shown by Next.js
// while the page's server component awaits TMDB + Prisma data, so
// users get an instant structural response instead of staring at
// the previous page until the new one resolves.
