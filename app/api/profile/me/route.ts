...
export async function PATCH(req: NextRequest) {
  try {
    ...
    const { name, avatarUrl, bio, isPrivate, autoDateOnSeen, autoSeenOnWatchlistCheck, publicTabs, notificationPrefs, profileTheme, emailOptOut, emailPrefs } = await req.json();
