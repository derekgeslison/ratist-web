        ...
        <div className="flex flex-col gap-3 mb-4">
          ...
          <div className="flex items-center gap-1.5 flex-wrap">
            ...
            {([
              ...
              { mode: "score", label: "Top Voted", icon: TrendingUp, gated: false },
              ...
              <button
                ...
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-colors ${sort === mode ? "bg-emerald-600 text-white" : "bg-[var(--surface)] border border-[var(--border)] text-[var(--foreground-muted)] hover:text-white"}`}
              >
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          <p className="text-[var(--foreground-muted)] mb-3">
            No pitches match{sort === "following" ? " from anyone you follow" : sort === "critics" ? " from critics" : sort === "controversial" ? " (need 5+ votes to qualify)" : ""}.
          </p>
          <button onClick={() => setSort("newest")} className="text-sm text-emerald-400 hover:underline">Show all</button>
        </div>
      ) : (
