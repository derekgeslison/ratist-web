      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
        {MPA_BUCKETS.map((b, idx) => (
          <Leaderboard
            ...
            share={{
              path: `/box-office/all?mpa=${encodeURIComponent(b.code)}&sort=revenue-desc`,
              ogPath: `/api/og/box-office?page=mpa&code=${encodeURIComponent(b.code)}`,
              shareText: `Top ${b.code}-Rated of All Time — The Ratist`,
            }}
          />
        ))}
      </div>
