...
export const metadata: Metadata = { title: "News", description: "The latest movie and TV show news, new trailers, casting announcements, and release updates — curated daily with editorial takes from The Ratist.", alternates: { canonical: "/news" } };
